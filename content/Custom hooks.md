I am mostly only including this one for completeness since it doesn't actually separate out the presentational component. That said, it *does* create a reusable piece of functionaliy for us.
